#
#  Be sure to run `pod spec lint gasonframework.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
  gason is a light and fast C++ JSON parser. We leverage it and make it avaliable in Swift.
                   DESC
  ...
  # Or just: s.author    = "Benjamin"
  # s.authors            = { "Benjamin" => "orbenappdev@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Benjamin"
